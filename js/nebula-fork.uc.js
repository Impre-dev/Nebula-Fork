...
(function () {
  ...
  // ========== NebulaForkCtrlTabDualBackgroundModule ==========
  // Creates dual background overlays (above + below) for the Ctrl+Tab panel.

  class NebulaForkCtrlTabDualBackgroundModule {
    ...
    init() {
      if (!this.browser || !this.panel) {
        return NebulaFork.logger.warn(
          "[CtrlTabDualBackground] Required elements not found.",
        );
      }
      ...
      NebulaFork.logger.log("[CtrlTabDualBackground] Initialized.");
    }
    ...
    destroy() {
      ...
      this.overlays = {};
      NebulaFork.logger.log("[CtrlTabDualBackground] Destroyed.");
    }
  }
  ...
  NebulaFork.register(NebulaForkCtrlTabDualBackgroundModule);
